                                    ...
                                    <div class="data-content">
                                        <div id="options-container" style="display: none;">
                                            <label>Number of Options:
                                                <input type="number" id="num-options" min="1" value="{{ old('options') ? count(old('options')) : 1 }}" required>
                                            </label>
                                        </div>
        ...
        if (questionType === 'multiple_choice') {
            ...
            optionsBody.innerHTML = `
                <tr>
                    <td>1</td>
                    <td>True</td>
                    <td><input type="radio" name="correct_answer" value="true" ${oldCorrectAnswers.includes('true') ? 'checked' : ''} required></td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>False</td>
                    <td><input type="radio" name="correct_answer" value="false" ${oldCorrectAnswers.includes('false') ? 'checked' : ''} required></td>
                </tr>
            `;
